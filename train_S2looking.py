...
def train():
    ...
    # build network
    student_net = models.EfficientNetB0_CD(num_classes, pretrained=True).to(torch_device)
    teacher_net = models.EfficientNetB0_CD(num_classes, pretrained=True).to(torch_device)
