...
def get_arguments():
    ...
    parser.add_argument("--work_dirs", type=str, default='./semi_checkpoints/WHU/CutMixCD')
    parser.add_argument("--log", type=str, default='cutmix_0.5')
    parser.add_argument("--weight_path", type=str, default='./semi_checkpoints/WHU/CutMixCD/cutmix_0.5/best.pth')
    parser.add_argument("--data_root", type=str, default='./WHU-CD256')
